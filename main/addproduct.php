...
<form action="saveproduct.php?cashh=<?php echo $_GET['cashh'];?>&invoice=<?php echo $_GET['invoice'];?>&page=<?php echo $_GET['page'];?>" method="post">
...
<span>Quantity : </span><input type="number" style="width:265px; height:40px;" min="0" id="txt11" onkeyup="sum();" name="qty" Required ><br/>
