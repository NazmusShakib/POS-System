...
<form action="saveeditproduct.php?cashh=<?php echo $cashh ?>&invoice=<?php echo $invoice ?>&page=<?php echo $page ?>" method="post">
...
<span>Part Number : </span><input type	="text" style="width:265px; height:30px;" name="exdate" value="<?php echo $row['expiry_date']; ?>" /><br>
