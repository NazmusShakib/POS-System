...
<div id="page-content-wrapper">		
	...
	<div class="row">		
		<div class="col-lg-12">
	<a href="sales.php?id=cash&invoice=<?php echo $finalcode ?>"><button class="btn btn-danger"><i class="icon-arrow-left"></i> Back to Sales</button></a>
...
<div style="margin: 0 auto; padding: 20px; width: 900px; font-weight: normal;">
	...
	<center><div style="font:bold 25px 'Aleo';">Sales Receipt</div>
		...
		<font style=" font:bold 15px 'Aleo'; text-shadow:1px 1px 25px #000; color:#fff;">Address</br>cell: </center></font>
	</center>
	<div>
	<?php
