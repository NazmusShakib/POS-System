...
<div id="page-content-wrapper">		
	<div class="container-fluid">		
		<div class="col-lg-12">
			...
			?></td>
			<td> 				
			<a href="deletesalesinventory.php?id=<?php echo $row['transaction_id']; ?>&qty=<?php echo $row['qty'];?>"><button class="btn btn-mini btn-danger"><i class="icon icon-trash"></i></button></a>
			</tr>
			<?php
				}
			?>
